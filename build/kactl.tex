...
% UniShortName and 
\university{EPFL}{École polytechnique fédérale de Lausanne}{Logo_EPFL} % UniShortName, UniFullName, UniLogoName
\team{EPicFLame}{Botu Lyu, Eduard-Alex Mihai, Khanh Nguyen} % TeamName, TeamMembers
